"""Binary sensor platform for real_electricity_price."""
...
ENTITY_DESCRIPTIONS = (
    BinarySensorEntityDescription(
        ...
        name="Real Electricity Price Connectivity",
...
async def async_setup_entry(
    ...
    async_add_entities(
        RealElectricityPriceBinarySensor(
...
class RealElectricityPriceBinarySensor(RealElectricityPriceEntity, BinarySensorEntity):
    """real_electricity_price binary_sensor class."""
