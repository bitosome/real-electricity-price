...
class CurrentPriceSensor(RealElectricityPriceBaseSensor):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            "grid_costs": self._get_grid_costs(config),
            "supplier_costs": self._get_supplier_costs(config),
            "price_breakdown": self._get_legacy_price_breakdown(config),
        }
    ...
    def _get_grid_costs(self, config: IntegrationConfig) -> dict[str, float]:
        """Get grid costs breakdown."""
    ...
    def _get_legacy_price_breakdown(
        ...
        """Get legacy price breakdown for backward compatibility."""
        grid_name = config.grid
        supplier_name = config.supplier
