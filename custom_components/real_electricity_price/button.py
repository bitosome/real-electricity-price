...
class RealElectricityPriceCalculateCheapHoursButton(RealElectricityPriceEntity, ButtonEntity):
    """Button to manually calculate cheap hours."""

    def __init__(self, coordinator: RealElectricityPriceDataUpdateCoordinator, cheap_coordinator: CheapPriceDataUpdateCoordinator) -> None:
        """Initialize the button."""
        super().__init__(coordinator)
        ...
        self._attr_unique_id = f"{coordinator.config_entry.entry_id}_calculate_cheap_hours_button"
