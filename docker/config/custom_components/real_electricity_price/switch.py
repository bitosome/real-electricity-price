"""Switch platform for real_electricity_price."""
...
ENTITY_DESCRIPTIONS = (
    SwitchEntityDescription(
        ...
        name="Real Electricity Price Switch",
...
class RealElectricityPriceSwitch(RealElectricityPriceEntity, SwitchEntity):
    """real_electricity_price switch class."""
