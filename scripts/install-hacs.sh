...
# 
# This script downloads and installs HACS into the Home Assistant container
# configuration directory for development and testing purposes.
#
...
show_instructions() {
    ...
    echo -e "   1. Start the development environment: ${YELLOW}./scripts/dev-setup.sh${NC}"
    echo -e "   2. Access Home Assistant: ${YELLOW}http://localhost:8123${NC}"
    echo -e "   3. Complete initial Home Assistant setup"
    echo -e "   4. Go to Settings → Devices & Services"
    echo -e "   5. Configure HACS integration"
    echo -e "   6. Add repository: ${YELLOW}https://github.com/bitosome/real-electricity-price${NC}"
    ...
    echo -e "   • Configuration: ${YELLOW}container/config/configuration.yaml${NC}"
